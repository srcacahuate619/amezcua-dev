  ...
  return (
    <section style={{
      ...
      <div className="animate-fade-up-d1" style={{
        ...
        Linares, Nuevo León · Disponible para proyectos
      </div>

      {/* Headline */}
      <h1 data-letters data-letters-speed="0.012" style={{
      ...
      <p className="animate-fade-up-d3" style={{
        ...
        Johan Amezcua — implemento IA en negocios de Linares: chatbots, agentes y sistemas que trabajan solos.
      </p>
      ...
      <p className="animate-fade-up-d3" style={{
        ...
        Automatizo lo que hoy haces a mano, construyo software a la medida y creo páginas que venden. Sin agencias, sin intermediarios: tratas directo con quien hace el trabajo. Comercios, despachos, tiendas, industria — si hay un proceso manual, se puede automatizar.
      </p>
      ...
      <div className="animate-fade-up-d5" style={{
        ...
        {[
          { num: '7', label: 'Proyectos construidos' },
          { num: '3', label: 'Publicaciones científicas con DOI' },
          { num: '100%', label: 'Trabajo directo, sin intermediarios' },
        ].map(({ num, label }) => (
          <div key={label}>
